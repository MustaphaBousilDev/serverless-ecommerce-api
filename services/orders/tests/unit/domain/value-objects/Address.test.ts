...
describe('Address Value Object', () => {
  ...
  describe('Address Serialization', () => {
    ...
    test('should reconstruct from plain object', () => {
      const address = Address.fromObject(validAddressData);
