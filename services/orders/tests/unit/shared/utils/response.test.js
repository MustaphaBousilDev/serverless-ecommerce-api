...
const response_1 = require("../../../../src/shared/utils/response");
describe('Response Utilities', () => {
    describe('success', () => {
        test('should create success response with 200 status', () => {
            const data = { id: '123', name: 'Test' };
            const result = (0, response_1.success)(200, data, 'Success message');
        ...
        test('should use default message when not provided', () => {
            const result = (0, response_1.success)(200, { test: 'data' });
            const body = JSON.parse(result.body);
    ...
    describe('error', () => {
        test('should create error response with correct structure', () => {
            const result = (0, response_1.error)(500, 'Error occurred', { detail: 'something' }, 'ERROR_CODE');
        ...
        test('should create default error code when not provided', () => {
            const result = (0, response_1.error)(400, 'Bad request');
            const body = JSON.parse(result.body);
    ...
    describe('badRequest', () => {
        test('should create 400 response', () => {
            const result = (0, response_1.badRequest)('Invalid input', ['error1', 'error2']);
        ...
        test('should use default message', () => {
            const result = (0, response_1.badRequest)();
            const body = JSON.parse(result.body);
    ...
    describe('notFound', () => {
        test('should create 404 response', () => {
            const result = (0, response_1.notFound)('Resource not found');
    ...
    describe('internalError', () => {
        test('should create 500 response', () => {
            const result = (0, response_1.internalError)('Server error', { stack: 'trace' });
            expect(result.statusCode).toBe(500);
            const body = JSON.parse(result.body);
            expect(body.success).toBe(false);
    ...
    describe('created', () => {
        test('should create 201 response', () => {
            const data = { id: '123' };
            const result = (0, response_1.created)(data, 'Created successfully');
    ...
    describe('ok', () => {
        test('should create 200 response', () => {
            ...
            const result = (0, response_1.ok)(data, 'OK');
            expect(result.statusCode).toBe(200);
            const body = JSON.parse(result.body);
            expect(body.success).toBe(true);
            expect(body.data).toEqual(data);
    ...
    describe('CORS headers', () => {
        test('should include CORS headers in all responses', () => {
            const successRes = (0, response_1.success)(200, {});
            const errorRes = (0, response_1.error)(500, 'Error');
