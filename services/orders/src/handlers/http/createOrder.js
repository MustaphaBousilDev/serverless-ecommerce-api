...
var CreateOrderUseCase_1 = require("../../application/usecases/CreateOrderUseCase");
...
var logger = (0, logger_1.createLogger)('CreateOrderHandler');
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var requestBody, validation, orderRepository, createOrderUseCase, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                validation = OrderValidator_1.OrderValidator.validateCreateOrder(requestBody);
                ...
                createOrderUseCase = new CreateOrderUseCase_1.CreateOrderUseCase(orderRepository);
            ...
            case 2:
                ...
                return [2 /*return*/, (0, response_1.created)(result, 'Order created successfully')];
            case 3:
                error_1 = _a.sent();
                ...
                logger.error('Unexpected error creating order', error_1);
                return [2 /*return*/, (0, response_1.internalError)('Failed to create order')];
