...
var S3Service = /** @class */ (function () {
    ...
    S3Service.prototype.uploadFile = function (bucketName, key, body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        console.log("File uploaded to S3: ".concat(key));
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
    ...
    S3Service.prototype.getFile = function (bucketName, key) {
        return __awaiter(this, void 0, void 0, function () {
            var command, response, stream, chunks, _a, stream_1, stream_1_1, chunk, e_1_1, error_2;
            var _b, e_1, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 15:
                        error_2 = _e.sent();
                        console.error('Error getting file from S3:', error_2);
