...
var EventBridgeService = /** @class */ (function () {
    function EventBridgeService() {
        this.client = new client_eventbridge_1.EventBridgeClient({
            region: aws_config_1.AWS_CONFIG.region
        });
    }
    EventBridgeService.prototype.publishEvent = function (detailType, detail) {
        return __awaiter(this, void 0, void 0, function () {
            var command, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        command = new client_eventbridge_1.PutEventsCommand({
                            Entries: [
                                {
                                    Source: 'ecommerce.orders',
                                    DetailType: detailType,
                                    Detail: JSON.stringify(detail),
                                    EventBusName: aws_config_1.EVENT_BUS.NAME
                                }
                            ]
                        });
                        _a.label = 1;
                    ...
                    case 2:
                        _a.sent();
                        console.log("Event published: ".concat(detailType));
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error publishing event to EventBridge: ', error_1);
